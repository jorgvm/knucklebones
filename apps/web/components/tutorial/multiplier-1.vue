...
<template>
  <div>
    <div class="-mt-12 -mb-10 scale-75">
      ...
      >
        opponent
        <span class="font-mono text-sm"> 0 points </span>
      </h1>
      ...
      >
        you
        <span class="font-mono text-sm"> 16 points </span>
      </h1>
    </div>
    ...
    <div>
      ...
      <p>
        <span class="font-clear">4&times;2 + 4&times;2 = 16 points</span>
      </p>
    </div>
  </div>
</template>
